...
#python3 SAT.py sudoku/own_test.txt -------->>>>>> Run this command 'sudoku/own_test.txt' should be adjusted to the correct row length, I'm still working on it
